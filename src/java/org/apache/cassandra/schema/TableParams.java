...
public final class TableParams
{
    ...
    public final SpeculativeRetryPolicy upgradeCheapQuorum;
    ...
    private TableParams(Builder builder)
    {
        ...
        upgradeCheapQuorum = builder.upgradeCheapQuorum;
    ...
    public static Builder builder(TableParams params)
    {
        return new Builder().bloomFilterFpChance(params.bloomFilterFpChance)
                            ...
                            .upgradeCheapQuorum(params.upgradeCheapQuorum)
    ...
    public static final class Builder
    {
        ...
        private SpeculativeRetryPolicy upgradeCheapQuorum = PercentileSpeculativeRetryPolicy.NINETY_NINE_P;
