...
public class BatchlogManager implements BatchlogManagerMBean
{
    ...
    private static class ReplayingBatch
    {
        ...
        private static class ReplayWriteResponseHandler<T> extends WriteResponseHandler<T>
        {
            ...
            {
                super(ReplicaLayout.forWrite(keyspace, ConsistencyLevel.ALL, writeReplicas.token(), writeReplicas, writeReplicas, EndpointsForToken.empty(writeReplicas.token())),
            ...
            {
                return this.replicaPlan.selectedReplicas().size();
            }
