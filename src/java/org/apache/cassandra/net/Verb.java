...
public enum Verb
{
    ...
    ACCORD_GET_DEPS_RSP             (143, P2, writeTimeout, IMMEDIATE,          () -> CalculateDepsSerializers.reply,       RESPONSE_HANDLER                                                            ),
    ACCORD_GET_DEPS_REQ             (144, P2, writeTimeout, IMMEDIATE,          () -> CalculateDepsSerializers.request,     AccordService::verbHandlerOrNoop, ACCORD_GET_DEPS_RSP                       ),
