...
public class WriteResponseHandler<T> extends AbstractWriteResponseHandler<T>
{
    ...
    public WriteResponseHandler(ReplicaLayout.ForToken replicaPlan,
                                Runnable callback,
                                WriteType writeType,
    ...
    public WriteResponseHandler(ReplicaLayout.ForToken replicaPlan, WriteType writeType, long queryStartNanoTime)
    {
